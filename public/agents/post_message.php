...
$sender = login();
$agent_result = find_agent_by_id($agent['id']);
$agent = db_fetch_assoc($agent_result);
$encrypted_data = pkey_encrypt($_POST['plaintext']$agent['public_key']);
$signature = create_signature($encrypted_data, $sender['private_key']);
